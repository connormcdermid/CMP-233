...
public class AList<T> implements ListInterface<T> {
     ...
     * @throws ListException Exceptional conditions: full list, null entry.
     */
    @Override
     ...
     * @throws ListException Exceptional conditions: full list, null object, bad position.
     */
     ...
     * @throws ListException If the list is empty or the position supplied is bad, ListException will be thrown
     */
     ...
     * @throws ListException if the item is null, the position is bad, or the list is empty.
     */
